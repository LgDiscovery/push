...
/**
 * 编辑${tableClass.introspectedTable.fullyQualifiedTable.remark}参数
 *
 * @author YangGuang
 * @version v1.0.0
 * @since ${.now}
...
@Setter
@Getter
@ApiModel(value = "编辑${tableClass.introspectedTable.fullyQualifiedTable.remark}参数")
public class ${tableClass.shortClassName}Edit extends ${tableClass.shortClassName}Id {
